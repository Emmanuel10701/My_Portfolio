...
,
  ...
  const testimonials = [
    ...
    {
      testimonial:
        "Currently pursuing a degree in Mathematics and Software Engineering, I’m building a strong foundation in software development, data analysis, and devops fueling my passion for technology.",
      name: "Dedan Kimathi University of Technology",
      designation: "[2023-2026]",
